...
public class Dimension {
    ...
    private double calculoLinha(int indice, int posicao) throws BIException {
        ...
        if (this.temDimensoesAbaixo()) {
            ...
            if (campo.isHorizontalParticipation() || campo.isHorizontalParticipationAccumulated() || campo.getAccumulatedOrder() != 0) {
                ...
                this.getTotalLines().computeIfAbsent(String.valueOf(campo.getCode()), k -> finalValAux);
            }
            ...
            if (campo.isHorizontalParticipation() || campo.isHorizontalParticipationAccumulated() || campo.getAccumulatedOrder() != 0) {
                ...
                this.getTotalLines().computeIfAbsent(String.valueOf(campo.getCode()), k -> finalValAux1);
            }
        }
    ...
    private void caminha(Dimension dimensao, TabelaHTML tabela, Field[] metricas, boolean coluna, Object[][] resultadosTodos, int indiceDimensaoLinha, int indiceDimensaoRaizLinha) throws BIException, DateException {
        ...
        if (resultado.length > 1 && dimensao.temDimensoesAbaixo()) {
            ...
            NumberFormat nfPerc = NumberFormat.getPercentInstance(Locale.GERMANY);
            nfPerc.setMinimumFractionDigits(2);
                    ...
                    if (resultado.length > 1) {
                            ...
                            if (resultado[0][j] != null && resultado[0][j].equals(metricas[i])) {
                                if (!((Field) resultado[0][j]).getDefaultField().equals("T")) {
                                    ...
                                    if (resultado[0][j] == null) {
                                        ...
                                        linha.getCelulaAtual().setAlinhamento(((Field) resultado[0][j]).getColumnAlignmentPosition());
                                    }
                                    ...
                                    if (((Field) resultado[0][j]).isTotalizingField()) {
                                        if (((Field) resultado[0][j]).isVerticalAnalysis()) {
                                            ...
                                            if (resultado[0][j] == null || (Double) resultado[1][j + 1] == 0) {
                                                ...
                                                linha.getCelulaAtual().setConteudo(nfPerc.format(perc));
                                        ...
                                        if (((Field) resultado[0][j]).isAccumulatedParticipation()) {
                                            ...
                                            if (resultado[0][j] == null || (Double) resultado[1][j + 1] == 0) {
                                                ...
                                                linha.getCelulaAtual().setConteudo(nfPerc.format(Double.valueOf(soma / (Double) resultado[1][j + 1])));
                                            ...
                                            if (((Field) resultado[0][ii]).isHorizontalAnalysis()) {
                                                if (resultado[1][ii] != null) {
                                                    ...
                                                    if (ini != fin) {
                                                        if (ini != 0) {
                                                            res = (ini - fin) / ini;
                                                            linha.getCelulaAtual().setConteudo(nfPerc.format(Double.valueOf(-1 * res)));
                                                            ...
                                                            if (fin > 0) {
                                                                linha.getCelulaAtual().setConteudo(nfPerc.format(1));
                                                            } else if (fin < 0) {
                                                                linha.getCelulaAtual().setConteudo(nfPerc.format(-1));
                                                            }
                                                        }
                                                    } else {
                                                        linha.getCelulaAtual().setConteudo(nfPerc.format(0));
                                                    }
                                                } else {
                                                    linha.getCelulaAtual().setConteudo("-");
                                                }
                                    ...
                                    if (((Field) resultado[0][j]).isHorizontalParticipation()) {
                                        ...
                                        if (campo.isHorizontalParticipation()) {
                                            if (resultado[1][j] != null && campo.isMetric()) {
                                                ...
                                                double total = this.getTotalLines().get(String.valueOf(campo.getCode()));
                                                ...
                                                if (ini != 0) {
                                                    linha.getCelulaAtual().setConteudo(nfPerc.format(ini / total));
                                                } else {
                                    ...
                                    if (((Field) resultado[0][j]).isHorizontalParticipationAccumulated()) {
                                        ...
                                        if (resultado[1][j] != null && campo.isMetric()) {
                                            ...
                                            if (ini != 0) {
                                                ...
                                                linha.getCelulaAtual().setConteudo(nfPerc.format(ini));
                        ...
                        for (int w = 0; w < folhas; w++) {
                            if (!metricas[i].getDefaultField().equals("T")) {
                                linha.addCelula(new CelulaHTML());
                                linha.getCelulaAtual().setNowrap(true);
                                linha.getCelulaAtual().setAlinhamento(metricas[i].getColumnAlignmentPosition());
                                linha.getCelulaAtual().setConteudo("-");
    ...
    public Object[][] consulta(Object[][] resultados) {
        ...
        for (int i = 0; i < resultados[0].length; i++) {
            if (resultados[0][i] != null) {
                if (((Field) resultados[0][i]).getCode() == this.value.getField().getCode()) {
                    coluna = i;
                    break;
                }
            }
            ...
            if (this.bottomDimensions[i] != null) {
                if (!this.bottomDimensions[i].getValue().getField().getDefaultField().equals("T")) {
                    ...
                    if (linha.getCelulas().isEmpty()) {
                        ...
                        LinkHTML linkField = new LinkHTML("javascript:alteraField('" + this.bottomDimensions[i].getValue().getField().getCode() + "');", this.bottomDimensions[i].getValue().getField().getTitle(), "textWhiteOff");
                    ...
                    linha.getCelulaAtual().setAlinhamento(this.bottomDimensions[i].getValue().getField().getColumnAlignmentPosition());
                ...
                if (camposColuna != null) {
                    ...
                    for (Field field : camposColuna) {
                        if (field != null && !field.getDefaultField().equals("T")) {
                            ...
                            LinkHTML linkField = new LinkHTML("javascript:alteraField('" + field.getCode() + "');", field.getTitle(), "textWhiteOff");
                            if (!this.isMountTableWithoutLink()) {
                            ...
                            if (field.indicator.getFilters().getDimensionFilter() != null) {
                                temFiltro = field.indicator.verificaFiltros(field.indicator.getFilters().getDimensionFilter(), field);
                            }
                            ...
                            imagem.setId(field.getNickName() + field.getCode());

                            link = new LinkHTML("javascript:filtroHeader(" + field.getCode() + ",'" + imagem.getId() + "');", imagem);
                            ...
                            if (field.isNavigable()) {
                                link = new LinkHTML("javascript:browseDown(" + field.getCode() + ");", new ImagemHTML("imagens/_mais.gif"));
                            } else if (field.isNavigableUpwards()) {
                                link = new LinkHTML("javascript:browseUp(" + field.getCode() + ");", new ImagemHTML("imagens/_menos.gif"));
                            }
                    ...
                    if (field != null) {
                        if (!field.getDefaultField().equals("T") && !(field.getName().isEmpty() && field.getTitle().equals("total"))) {
                            if (!(indiceDimensaoRaizLinha == 0 && indiceDimensaoLinha == 0 && field.isHorizontalAnalysis() && field.getTitle().contains("AH%"))) {
                                ...
                                linha.getCelulaAtual().setEstilo(estilo);
                                linha.getCelulaAtual().setLargura(String.valueOf(field.getColumnWidth()));
                                linha.getCelulaAtual().setAlinhamento(field.getColumnAlignmentPosition());
                                linha.getCelulaAtual().setNowrap(true);
                                LinkHTML linkField = new LinkHTML("javascript:alteraField('" + field.getCode() + "');", field.getTitle(), "blueLinkDrillDown");
    ...
    private boolean escreveTotalParcial(LinhaHTML linhaHTML, int indiceLinha, int sequencia, List<DimensionTotalized> dimensoesTotalizadas) throws BIException, DateException {
        ...
        if (this.temDimensoesAbaixo()) {
            ...
            for (int ii = 3; ii < this.results[0].length; ii++) {
                ...
                if (campo != null && !campo.getDefaultField().equals("T")) {
                    ...
                    if (!campo.getAccumulatedLine().equals("N")) {
                        ...
                        celula.setNowrap(true);
                        celula.setEstilo(estilo);
                        celula.setAlinhamento(campo.getColumnAlignmentPosition());
                        ...
                        if (campo.isPartialTotalization()) {
                            ...
                            celula.setConteudo(nf.format(this.accumulatedLine[ii]));
                    ...
                    if (campo.isMediaLine()) {
                        ...
                        if (campo.isPartialTotalization()) {
                            ...
                            if (getColumnLineAmount() > 0) {
                                celula.setConteudo(nf.format(this.accumulatedLine[ii] / getColumnLineAmount()));
            ...
            if (total) {
                ...
                celula.setConteudo(nf.format(this.totalLine));
            }
        }
        return total;
    }
                        ...
                        if (pai.isPartialTotalization()) {
                            ...
                            if (totalizParcial != null) {
                                ...
                                if (pai.isApplyTotalizationExpression()) {
                                    ...
                                    fin = registroTotalizado.getDouble(pai.getCode());
                                }
                            ...
                            if (campo.isPartialTotalization()) {
                                if (!("".equals(campo.getName()))) {
                                    ...
                                    if (campo.isApplyTotalizationExpression()) {
                                        ...
                                        soma = registroTotalizado.getDouble(campo.getCode());
                                    }
                                ...
                                if (campo.isChildField() && campo.getTitle().startsWith("AH Participa��o")) {
                                    ...
                                    if (pai != null && this.partialTotalizations != null) {
                                        ...
                                        if (totalizParcial != null) {
                                            ...
                                            if (pai.isApplyTotalizationExpression()) {
                                                Expression.aplicaExpressaoNoRegistroTotalizado(this.indicator, pai, registroTotalizado);
                                                soma = registroTotalizado.getDouble(pai.getCode());
                                            }
                                            totalizParcial.setPartialTotalization(soma);
                                            this.indicator.setPartialTotalizations(this.partialTotalizations);
                                            ...
                                            if (this.getAccumulatedLine(indice) != 0) {
                                                ...
                                                conteudo = nfPerc.format(soma / this.getAccumulatedLine(indice));
                                            }
                                        }
                                    }
                                        ...
                                        if (totalizParcial != null) {
                                            ...
                                            if (ini != fin) {
                                                if (ini != 0) {
                                                    ...
                                                    conteudo = nfPerc.format(Double.valueOf(-1 * res));
                                                } else {
                                                    if (fin > 0) {
                                                        conteudo = nfPerc.format(1);
                                                    } else if (fin < 0) {
                                                        conteudo = nfPerc.format(-1);
                                                    }
                                                }
                                            } else {
                                                conteudo = nfPerc.format(0);
                                            }
                                        } else {
                                            conteudo = "-";
                                        }
    ...
    public Field getFieldPai(Field filho, Object[][] valores) {
        ...
        for (int i = 3; i < valores[0].length; i++) {
            ...
            if (campo != null) {
                if (campo.getCode() == filho.getCode() && !campo.isChildField()) {
                    retorno = campo;
                    break;
                }
            } else {
    ...
    private void setaTotalizacao(Field campo, Object[][] valores, int sequencia, double totalizacao, CachedResults registroTotalizado) throws BIException {
        ...
        registroTotalizado.setDouble(totalizacao, campo.getCode());
        this.indicator.setPartialTotalizations(this.partialTotalizations);
    }
    ...
    public Field[] getFieldsDaDimensao() {
        Field[] retorno = new Field[this.results[0].length];
        for (int i = 0; i < this.results[0].length; i++) {
            retorno[i] = (Field) this.results[0][i];
        }
        return retorno;
    }
    ...
    public double calculaExpressaoAcumulado(Field campo, int indice) throws BIException {
        ...
        if (campo != null && campo.isExpression() && campo.getAccumulatedLine().equals("E")) {
            Expression expressao = indicator.getExpressaoField(campo.getName());
            if (indicator.hasAllExpressionFields(this.getFieldsDaDimensao(), campo)) {
                ...
                if (campo.isExpression() && (campo.getName().toUpperCase().trim().indexOf("SE(") == 0 || campo.getName().toUpperCase().trim().indexOf("IF(") == 0)) {
                    ConditionalExpression expressaoCondicional = indicator.getExpressaoCondicional(campo.getName());
                    valorDaExpressao = indicator.calculaExpressaoCondicional(expressaoCondicional, cacheResult);
                } else {
    ...
    public double getAcumuladoLinhaAtualizado(int indiceField) {
        ...
        if (!this.filterBySequence) {
            if (this.temDimensoesAbaixo()) {
                for (int i = 0; i < this.bottomDimensions.length; i++) {
                    if (this.bottomDimensions[i] != null) {
                        retorno += this.bottomDimensions[i].getAcumuladoLinhaAtualizado(indiceField);
                    } else {
                        break;
                    }
                }
    ...
    public void removeValorTotalizacaoField(Object[][] resultados, double valor, Field campoValor, ArrayList<Dimension> chaveDimensao, Dimension colunaPai, int tipo) {
        ...
        for (int i = 0; i < resultados[0].length; i++) {
            ...
            if (campoRef.getCode() == campoAux.getCode()) {
