...
public class MetricCalculatedParticipacaoAHMetaData extends MetricCalculatedParticipacaoMetaData {
    ...
    public MetricCalculatedParticipacaoAHMetaData(MetricMetaData colunaReferencia, AnaliseParticipacaoTipo analiseVerticalTipo, List<AlertaCorMetaData> alertasCores) {
